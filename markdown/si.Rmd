...
```{r es1, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 5, fig.cap = "\\label{fig:es-1}Event Study Plot, Weather + Administrative Treatment, All Treated Voters", fig.pos = "H", fig.align = "center"}
