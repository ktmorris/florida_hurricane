...
\addcontentsline{toc}{subsection}{Changes in Covered Counties}
...
\addcontentsline{toc}{subsection}{Impact on Registrations}
...
\addcontentsline{toc}{subsection}{AME Event Study Plots}
...
\addcontentsline{toc}{subsection}{Alternative Processing Approaches for AME}
...
\addcontentsline{toc}{subsection}{County-Specific Effects}
...
\subsection*{Regression Table for Triple-Differences Model}\label{regression-table-for-triple-differences-model}}
\addcontentsline{toc}{subsection}{Regression Table for Triple-Differences Model}
...
\addcontentsline{toc}{subsection}{Administrative Treatment Effect Event Study Plots}
...
\addcontentsline{toc}{subsection}{Alternative Modelling Approaches for Triple-Differences Model}
...
\addcontentsline{toc}{subsection}{Limiting the Panel to Voters Registered Prior to 2010}
...
\addcontentsline{toc}{subsection}{Multinomial Regression Table}
