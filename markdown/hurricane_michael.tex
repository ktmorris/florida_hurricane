...
The coefficient on \emph{Treated × 2018} in Table \ref{tab:full-dind} indicates that Hurricane Michael, net of any county- and state-level administrative responses, reduced turnout in 2018 among the treated voters. The coefficients in Table \ref{tab:full-dind}, however, are difficult to interpret. To understand the magnitude of the depressive effect, we calculate what each voter's predicted probability of turning out in 2018 would have been absent the treatment effect. We do so by using each of the coefficients in the regression output except for \emph{Treated × 2018}. These predicted probabilities indicate that turnout among treated voters in 2018 should have been between 67.4 and 67.7 percent. Given that the observed turnout for this group was 58.5 percent, this implies that Hurricane Michael reduced turnout by roughly 9 percentage points. Multiplied across the nearly 200 thousand registered voters in the treated counties indicates that some 18 thousand ballots went uncast due to the hurricane --- a major effect in a year when a statewide senate race was decided by 10,033 votes.
...
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-9}
 & Treated & Control & Treated & Control & Mean Diff & eQQ Med & eQQ Mean & eQQ Max\\
\midrule
\%White & 75.0\% & 83.0\% & 75.0\% & 75.0\% & 99.86 & 86.10 & 86.10 & 86.10\\
\% Black & 21.0\% & 12.0\% & 21.0\% & 21.0\% & 100.00 & 65.14 & 65.14 & 65.14\\
\% Latino & 2.0\% & 2.0\% & 2.0\% & 1.0\% & 84.19 & -849.36 & -849.36 & -849.36\\
\% Asian & 0.0\% & 1.0\% & 0.0\% & 0.0\% & 100.00 & -2.80 & -2.80 & -2.80\\
\% Female & 53.0\% & 53.0\% & 53.0\% & 53.0\% & 81.63 & -414.61 & -414.61 & -414.61\\
\% Male & 45.0\% & 46.0\% & 45.0\% & 45.0\% & 85.34 & -667.24 & -667.24 & -667.24\\
Age & 52.54 & 51.61 & 52.54 & 52.51 & 97.73 & -50.80 & -57.33 & -50.09\\
\% Democrat & 44.0\% & 39.0\% & 44.0\% & 44.0\% & 99.50 & 77.06 & 77.06 & 77.06\\
\% Republican & 42.0\% & 45.0\% & 42.0\% & 42.0\% & 99.64 & 31.81 & 31.81 & 31.81\\
\% with Some College & 64.0\% & 67.0\% & 64.0\% & 67.0\% & -25.09 & -115.34 & -81.31 & -61.56\\
Median Income & \$47,598 & \$49,407 & \$47,598 & \$50,053 & -35.74 & 8.00 & -6.47 & -14.54\\
\bottomrule
\end{tabular}}
\end{table}
\end{singlespace}
