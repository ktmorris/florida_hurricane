...
Table \ref{tab:trip-diff} presents the results of this model. Model 1 includes only the dummies discussed above, while Model 2 includes all the covariates on which the matching procedures were performed. Model 3 also includes estimates for congressional district competitiveness in 2018. Robust standard errors are clustered at the level of the original treated voter from which the primary and secondary controls arise.
...
The coefficient on *Treated × 2018*, however, is statistically significant and negative. This indicates that treated voters in the counties covered by the executive order turned out at lower rates than voters in bordering precincts but different counties. The depressed turnout for these voters, therefore, can be explained entirely by *administrative* effects, and not by direct any individual effects of the storm on propensity to vote.
