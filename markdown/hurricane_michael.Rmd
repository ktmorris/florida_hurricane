...
## Testing Administrative Effects {-}
...
**Hypothesis 3**: As the difference between the actual and planned distance to the closest polling place increased for voters, they were more likely to vote absentee and to abstain from voting, relative to past behavior, all else being held equal.
...
The coefficients on *Panhandle* in Table \ref{tab:trip-diff} demonstrate that prior to 2018, Panhandle voters generally saw turnout that was 4.1 -- 4.4 percentage points above the turnout of the secondary controls. The combination of *Treated* and *Treated × Midterm* indicates that treated voters turned out at slightly higher rates than primary control voters in midterm elections, and at lower rates in presidential years.

The coefficient for *Panhandle × 2018* in each model in Table \ref{tab:trip-diff} indicates that turnout in 2018 was slightly higher for primary control voters than for secondary control voters. As a whole, Panhandle voters saw turnout about 1.3 percentage points above what might have been expected.

The coefficients on *Treated × 2018*, however, indicate that turnout was depressed for treated voters who lived just inside counties covered by the executive order. Because the treated and primary control voters faced the same weather --- and therefore individual effects --- of the storm, this loss in turnout can be attributed to the administrative problems faced by the treated voters. Each model estimates that this effect was -3.3 percentage points.
...
```{r marg-multi, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 5, fig.cap = "\\label{fig:marg-multi}Share of Voters Participating by Vote Method, 2010 -- 2018", fig.pos = "H", fig.align = "center"}
